          ...
          return (
            ...
            >
              ...
              <TableCell>
                <Box sx={{ border: 1 }}>
                  Whitelists:
                  <T className={classes.accessText}>{ sound.accessWhitelists.length ? sound.accessWhitelists.join(', ') : '<None>' }</T>
                </Box>
                <div>
                  User overrides:
                  <T className={classes.accessText}>{ sound.accessUsernames.length ? sound.accessUsernames.join(', ') : '<None>' }</T>
                </div>
                <div>
                  Roles:
                  {
                    sound.access.length
                      ? sound.access.map(s => (
                        <div key={s}>
                          <IconHelper access={s} />
                          <T className={classes.accessText}>{s}</T>
                        </div>
                      ))
                      : '<None>'
                  }
